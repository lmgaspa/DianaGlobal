...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8 text-sm md:text-base">
      ...
      <h2 className="text-2xl font-bold mb-2">10. Governing Law & Jurisdiction (Brazil)</h2>
      <p className="mb-4">
        This Privacy Policy shall be governed by and construed in accordance with the laws of the Federative Republic of Brazil. 
        Any disputes arising out of or relating to this Policy shall be submitted to the courts of the City of São Paulo, State of São Paulo, Brazil, without prejudice to mandatory consumer protection rules that may provide otherwise.
      </p>
    </div>
  );
};
