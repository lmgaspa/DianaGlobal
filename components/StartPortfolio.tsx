...
const StartPortfolio: React.FC = () => {
  ...
  return (
    <div className="flex md:flex-row justify-between items-center p-4 md:p-8 bg-blue-100 dark:bg-gray-600 text-gray-900 dark:text-gray-100" style={{ height: "40vh" }}>
